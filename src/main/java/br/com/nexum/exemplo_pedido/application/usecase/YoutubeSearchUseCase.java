...
import br.com.nexum.exemplo_pedido.domain.models.VideoInfo;
...
public class YoutubeSearchUseCase {
    ...
    private void pularAnuncio() {
        try {
            WebDriverWait wait = new WebDriverWait(browserService.getDriver(), Duration.ofSeconds(10));
    ...
    private VideoInfo coletarInformacoesVideo() {
        try {
            ...
            // Título do vídeo
            WebElement tituloElement = browserService.getWait().until(
            ...
            // Nome do canal
            WebElement canalElement = browserService.getWait().until(
            ...
            try {
                ...
                WebElement infoElement = browserService.getWait().until(
                ...
                try {
                    WebElement visualizacoesElement = browserService.getWait().until(
                ...
                // Fallback para data
                try {
                    WebElement dataElement = browserService.getDriver().findElement(
